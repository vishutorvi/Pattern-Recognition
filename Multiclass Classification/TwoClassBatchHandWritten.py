...
def singlesampleperceptron_one_against_other(ftrain, ftest, fcount):
    ...
    print('\n----------------Accuracy for one against other-----------------')        
    print('--------------------------------------------------------------')
    print('The performance of digit 0-1  classifier on wine data set is =',p12);
    print('The performance of digit 1-2  classifier on wine data set is =',p13);
    print('The performance of digit 1-2  classifier on wine data set is =',p23);
    print('--------------------------------------------------------------')
...
def singlesampleperceptron_one_against_rest(ftrain, ftest, fcount):
    ...
    print('--------------------------------------------------------------')
    print('The performance of two-class classifier for digit 0 against the rest using single sample on wine data set is =',p1);
    print('The performance of two-class classifier for digit 1 against the rest using single sample on wine data set is =',p2);
    print('The performance of two-class classifier for digit 2 against the rest using single sample on wine data set is =',p3);
    print('--------------------------------------------------------------')
