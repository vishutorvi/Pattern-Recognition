...
def singlesampleperceptron_one_against_other(ftrain, ftest, fcount):
    ...
    a12 = ssperceptrononeagainstother(X_norm[Y==1], X_norm[Y==2], a0, eta, b)
    a23 = ssperceptrononeagainstother(X_norm[Y==2], X_norm[Y==3], a0, eta, b)
    a13 = ssperceptrononeagainstother(X_norm[Y==1], X_norm[Y==3], a0, eta, b)
    ...
    print('--------------------------------------------------------------')
    print('The performance of class 1-2  classifier on wine data set is =',p12);
    print('The performance of class 1-3  classifier on wine data set is =',p13);
    print('The performance of class 2-3  classifier on wine data set is =',p23);
    print('--------------------------------------------------------------')
...
def singlesampleperceptron_one_against_rest(ftrain, ftest, fcount):
    ...
    for i in range(len(np.unique(Y))):
        print('i=',i)
        a[i,:] = singlePerceptron(X_norm, Y, i+1, a0, eta, b)
    ...
    for j in range(len(Y_test)):
        ...
        if ((Y_test[j] == 1 and cls == 1) or ((Y_test[j] == 2) or Y_test[j] == 3) and cls == -1):
            correct1 += 1
        ...
        if ((Y_test[j] == 2 and cls == 1) or ((Y_test[j] == 1) or Y_test[j] == 3) and cls == -1):
            correct2 += 1
        ...
        if ((Y_test[j] == 3 and cls == 1) or ((Y_test[j] == 1) or Y_test[j] == 2) and cls == -1):
            correct3 += 1
