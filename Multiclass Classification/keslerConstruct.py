# -*- coding: utf-8 -*-
"""
Created on Sun Nov 19 01:21:46 2017
...
def ReadData(fileName):
    ...
    for i in range(1, len(lines)):
        ...
        itemFeatures = {"Class" : line[0], "Bias" : 1};
...
###_Main_###
def main():
    items, classes, features = ReadData('./wine_train.txt');
    ...
    itemtest, classestest, features = ReadData('./wine_test.txt')
