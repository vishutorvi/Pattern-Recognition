# -*- coding: utf-8 -*-
"""
Created on Sun Nov 19 02:01:33 2017
...
def kernelPerceptron(ftrain,ftest,fcount):
    ...
    ker = KPerceptron()
    ker.partial_fit(X_norm,np.array(Y),classes=3)
    predictions = ker.predict(X_test_norm)
    
    print('Actual Accuracy=',np.sum(predictions == Y_test)/len(X_test_norm))
    
#kernelPerceptron('./wine_train.txt','./wine_test.txt', 13)
kernelPerceptron('./digit_train.txt','./digit_test.txt', 256)