    ...
    def fit(self, X,Y):
        ...
        for c in labels:
            ...
            self.gaussians[c]={
                ...
                'var':np.cov(current_x,rowvar=False)#+smoothing,#current_x.var(axis=0)#np.cov(current_x,rowvar=False)#+smoothing,
            }
...
analysis("sentimentdata.csv","sentimenttest.csv",',',500)
